...
__webpack_require__.d(__webpack_exports__, "useInsertionEffect", function() { return /* reexport */ compat_module_k; });
__webpack_require__.d(__webpack_exports__, "useTransition", function() { return /* reexport */ compat_module_w; });
__webpack_require__.d(__webpack_exports__, "useDeferredValue", function() { return /* reexport */ R; });
__webpack_require__.d(__webpack_exports__, "useSyncExternalStore", function() { return /* reexport */ compat_module_E; });
__webpack_require__.d(__webpack_exports__, "startTransition", function() { return /* reexport */ compat_module_x; });
...
__webpack_require__.d(__webpack_exports__, "version", function() { return /* reexport */ hn; });
__webpack_require__.d(__webpack_exports__, "Children", function() { return /* reexport */ compat_module_L; });
__webpack_require__.d(__webpack_exports__, "render", function() { return /* reexport */ X; });
...
__webpack_require__.d(__webpack_exports__, "flushSync", function() { return /* reexport */ gn; });
__webpack_require__.d(__webpack_exports__, "unstable_batchedUpdates", function() { return /* reexport */ Sn; });
__webpack_require__.d(__webpack_exports__, "StrictMode", function() { return /* reexport */ En; });
__webpack_require__.d(__webpack_exports__, "Suspense", function() { return /* reexport */ W; });
__webpack_require__.d(__webpack_exports__, "SuspenseList", function() { return /* reexport */ compat_module_z; });
__webpack_require__.d(__webpack_exports__, "lazy", function() { return /* reexport */ compat_module_j; });
...
__webpack_require__.d(compat_module_namespaceObject, "Children", function() { return compat_module_L; });
__webpack_require__.d(compat_module_namespaceObject, "PureComponent", function() { return compat_module_I; });
__webpack_require__.d(compat_module_namespaceObject, "StrictMode", function() { return En; });
__webpack_require__.d(compat_module_namespaceObject, "Suspense", function() { return W; });
__webpack_require__.d(compat_module_namespaceObject, "SuspenseList", function() { return compat_module_z; });
__webpack_require__.d(compat_module_namespaceObject, "__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED", function() { return sn; });
__webpack_require__.d(compat_module_namespaceObject, "cloneElement", function() { return yn; });
__webpack_require__.d(compat_module_namespaceObject, "createFactory", function() { return vn; });
__webpack_require__.d(compat_module_namespaceObject, "createPortal", function() { return Y; });
__webpack_require__.d(compat_module_namespaceObject, "default", function() { return xn; });
__webpack_require__.d(compat_module_namespaceObject, "findDOMNode", function() { return bn; });
__webpack_require__.d(compat_module_namespaceObject, "flushSync", function() { return gn; });
__webpack_require__.d(compat_module_namespaceObject, "forwardRef", function() { return compat_module_A; });
__webpack_require__.d(compat_module_namespaceObject, "hydrate", function() { return nn; });
__webpack_require__.d(compat_module_namespaceObject, "isElement", function() { return Cn; });
__webpack_require__.d(compat_module_namespaceObject, "isFragment", function() { return pn; });
__webpack_require__.d(compat_module_namespaceObject, "isMemo", function() { return mn; });
__webpack_require__.d(compat_module_namespaceObject, "isValidElement", function() { return dn; });
__webpack_require__.d(compat_module_namespaceObject, "lazy", function() { return compat_module_j; });
__webpack_require__.d(compat_module_namespaceObject, "memo", function() { return compat_module_N; });
__webpack_require__.d(compat_module_namespaceObject, "render", function() { return X; });
__webpack_require__.d(compat_module_namespaceObject, "startTransition", function() { return compat_module_x; });
__webpack_require__.d(compat_module_namespaceObject, "unmountComponentAtNode", function() { return _n; });
__webpack_require__.d(compat_module_namespaceObject, "unstable_batchedUpdates", function() { return Sn; });
__webpack_require__.d(compat_module_namespaceObject, "useDeferredValue", function() { return R; });
__webpack_require__.d(compat_module_namespaceObject, "useInsertionEffect", function() { return compat_module_k; });
__webpack_require__.d(compat_module_namespaceObject, "useSyncExternalStore", function() { return compat_module_E; });
__webpack_require__.d(compat_module_namespaceObject, "useTransition", function() { return compat_module_w; });
...
var popup_modal_PopupModal = /** @class */ (function (_super) {
    ...
    PopupModal.prototype.renderElement = function () {
        if (!this.model)
            return null;
        return Y(xn.createElement(popup_PopupContainer, { model: this.model }), this.model.container);
    };
...
Object(external_root_Survey_commonjs2_survey_core_commonjs_survey_core_amd_survey_core_["checkLibraryVersion"])("" + "1.12.14", "survey-js-ui");
